...
export default function JsIntegrationPage() {
        ...
        {mod.lessons.map((lesson, i) => {
          ...
          return (
            <motion.div
              ...
              <Link href={`/js-integration/${lesson.slug}`}>
                <Card hoverable>
                  <div className='flex items-center gap-4'>
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold ${
                        isComplete ? 'bg-success text-white' : 'bg-secondary-light/30 text-secondary'
                      }`}>
                    ...
                    <div className='w-24 shrink-0'>
                      <ProgressIndicator progress={progress} size='sm' color={mod.color} />
                    </div>
                  </div>
                </Card>
              </Link>
